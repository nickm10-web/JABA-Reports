...
const voiceAnalysisRows: VoiceAnalysisRow[] = [
  ...
  },
  {
    ...
    score: 'Brand-Led',
    takeaway: 'Clear launch framing from Monster’s side. Strong for announcement energy, but the caption is doing brand positioning work more than reflecting Maxx’s natural voice.',
  },
  {
    post: 'Post 3',
    ...
    score: 'Brand-Led',
    takeaway: 'Fast, visual, and in Monster’s tone. It supports the collab well as a brand asset, but the copy is intentionally minimal and not especially athlete-authored.',
  },
  {
    post: 'Post 4',
