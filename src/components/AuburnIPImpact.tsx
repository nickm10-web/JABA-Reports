    ...
    <div className="space-y-4">
      ...
      <div className="bg-white rounded-2xl shadow-sm px-4 py-3 flex items-start gap-3">
        ...
        <p className="text-sm text-gray-600">
          Data reflects <span className="font-semibold">Auburn athlete personal social media accounts</span>, including collaboration posts with official team pages.
          Metrics track how athletes use Auburn IP (logos, mentions, collaborations) in their content.
        </p>
      </div>
